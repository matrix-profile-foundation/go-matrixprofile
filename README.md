...
## Installation
```sh
$ go get -u github.com/matrix-profile-foundation/go-matrixprofile/matrixprofile
...
$ make example
go test ./... -run=Example
ok      github.com/matrix-profile-foundation/go-matrixprofile/matrixprofile      0.260s
ok      github.com/matrix-profile-foundation/go-matrixprofile/siggen     0.007s [no tests to run]
```
